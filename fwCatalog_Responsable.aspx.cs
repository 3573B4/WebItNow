...
{
    public partial class fwCatalog_Responsable : System.Web.UI.Page
    {
        ...
        protected void ddlResponsables_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (ddlResponsables.SelectedValue)
            {
                ...
                case "2":
                    // Gerentes
                    Variables.wIdColumna = "IdGerente";
                    Variables.wTabla = "ITM_79";
                ...
                case "3":
                    // Tecnicos
                    Variables.wIdColumna = "IdRespTecnico";
                    Variables.wTabla = "ITM_68";
