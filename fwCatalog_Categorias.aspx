<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Categorias.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Categorias" %>
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Categorías</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Categorias" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
...
<%--
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class ="mb-2">
                        <asp:Label ID="LblClave" runat="server" Text="Clave de Cliente"></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtCveCliente" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="Clave de Cliente" AutoComplete="off" MaxLength="3"></asp:TextBox>
                    </div>
                </div>
            </div>
--%>
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4">
                    <div class ="mb-2">
                        <asp:Label ID="LblSecciones" runat="server" Text="<%$ Resources:GlobalResources, lblCategoriasPor %>" ></asp:Label>
                    </div>
                    <div class=" input-group input-group-sm">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblCategoria" runat="server" Text="<%$ Resources:GlobalResources, lblDescCategoria %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomCategoria" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="<%$ Resources:GlobalResources, lblDescCategoria %>" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <%--<h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Categorías</h6>--%>
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, lblConsultaCategoria %>" />
                    </h6>
                </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdCategorias"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdCategorias_PageIndexChanging" OnRowCommand="GrdCategorias_RowCommand" OnPreRender="GrdCategorias_PreRender"
                            OnSelectedIndexChanged="GrdCategorias_SelectedIndexChanged" OnRowDataBound="GrdCategorias_RowDataBound" 
                            DataKeyNames="IdDocumento" PageSize="10" Font-Size="Smaller" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="IdDocumento"  HeaderText="<%$ Resources:GlobalResources, col_Clave %>" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Cve_Documento" HeaderText="<%$ Resources:GlobalResources, col_CveCategoria %>" >
                                </asp:BoundField>
