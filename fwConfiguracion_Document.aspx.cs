...
{
    public partial class fwConfiguracion_Document : System.Web.UI.Page
    {
        ...
        protected void GetCategorias_bk(int IdSeccion, string IdCliente, string Tabla)
        {
            try
            {
                ConexionBD_MySQL dbConn = new ConexionBD_MySQL(Variables.wUserName, Variables.wPassword);
                ...
                string strQuery = $"SELECT ROW_NUMBER() OVER (ORDER BY (SELECT NULL)) AS IdDocumento, { Tabla }.Descripcion " +
                                  $" FROM ITM_86 " +
                                  $" JOIN { Tabla } ON { Tabla }.IdDocumento IN ( " +
                                  $" CASE WHEN ITM_86.Doc1 = 1 THEN 1 END," +
                                  $" CASE WHEN ITM_86.Doc2 = 1 THEN 2 END," +
                                  $" CASE WHEN ITM_86.Doc3 = 1 THEN 3 END," +
                                  $" CASE WHEN ITM_86.Doc4 = 1 THEN 4 END," +
                                  $" CASE WHEN ITM_86.Doc5 = 1 THEN 5 END," +
                                  $" CASE WHEN ITM_86.Doc6 = 1 THEN 6 END," +
                                  $" CASE WHEN ITM_86.Doc7 = 1 THEN 7 END," +
                                  $" CASE WHEN ITM_86.Doc8 = 1 THEN 8 END," +
                                  $" CASE WHEN ITM_86.Doc9 = 1 THEN 9 END," +
                                  $" CASE WHEN ITM_86.Doc10 = 1 THEN 10 END," +
                                  $" CASE WHEN ITM_86.Doc11 = 1 THEN 11 END," +
                                  $" CASE WHEN ITM_86.Doc12 = 1 THEN 12 END," +
                                  $" CASE WHEN ITM_86.Doc13 = 1 THEN 13 END," +
                                  $" CASE WHEN ITM_86.Doc14 = 1 THEN 14 END," +
                                  $" CASE WHEN ITM_86.Doc15 = 1 THEN 15 END," +
                                  $" CASE WHEN ITM_86.Doc16 = 1 THEN 16 END," +
                                  $" CASE WHEN ITM_86.Doc17 = 1 THEN 17 END," +
                                  $" CASE WHEN ITM_86.Doc18 = 1 THEN 18 END )" +
                                  $"WHERE (ITM_86.Doc1 = 1 OR ITM_86.Doc2 = 1 OR ITM_86.Doc3 = 1 OR ITM_86.Doc4 = 1 OR ITM_86.Doc5 = 1 " +
                                  $"   OR ITM_86.Doc6 = 1 OR ITM_86.Doc7 = 1 OR ITM_86.Doc8 = 1 OR ITM_86.Doc9 = 1 OR ITM_86.Doc10 = 1 " +
                                  $"   OR ITM_86.Doc11 = 1 OR ITM_86.Doc12 = 1 OR ITM_86.Doc13 = 1 OR ITM_86.Doc14 = 1 OR ITM_86.Doc15 = 1 " +
                                  $"   OR ITM_86.Doc16 = 1 OR ITM_86.Doc17 = 1 OR ITM_86.Doc18 = 1 )" +
                                  $"  AND ITM_86.IdProyecto = " + ddlProyecto.SelectedItem.Value + " " +
                                  $"  AND ITM_86.IdCliente = '" + IdCliente + "' " +
                                  $"  AND ITM_86.IdSeccion = " + IdSeccion + " ";
        ...
        protected void GetCategorias(int IdSeccion, string IdCliente, string Tabla)
        {
            try
            {
                ...
                string strQuery = $"SELECT { Tabla }.IdDocumento, { Tabla }.Descripcion " +
                                  $"  FROM { Tabla } , ITM_86 " +
                                  $" WHERE { Tabla }.IdDocumento = ITM_86.IdDocumento" +
                                  "    AND ITM_86.IdProyecto = " + ddlProyecto.SelectedItem.Value + " " +
                                  "    AND ITM_86.IdSeccion = " + IdSeccion + " " +
                                  "    AND ITM_86.IdCliente = '" + IdCliente + "' " +
                                  "    AND ITM_86.bSeleccion = 1 ";

                if (ddlProyecto.SelectedItem.Value != "0")
                {
                       strQuery += "    AND ITM_86.IdTpoAsunto = '" + IdTpoAsunto + "' ";
                }
        ...
        protected void GetDocumentos(int IdProyecto, int IdCategoria, int IdSeccion)
        {
            try
            {
                ...
                // Consulta a las tablas : Estado de Documento (Expediente) = ITM_88
        ...
        public void GetDocumentos_Carpeta()
        {
            try
            {
                ...
                // Consulta a las tablas : Estado de Documento (Expediente) = ITM_90
                string strQuery = "SELECT d.IdConsecutivo, d.IdCarpeta, d.Descripcion " +
                                  "  FROM ITM_80 as p, ITM_90 as d " +
        ...
        protected void ddlSecciones_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                GetCategorias(1, IdCliente, "ITM_81");

            } else if (ddlSecciones.SelectedValue == "2")
            {
                GetCategorias(2, IdCliente, "ITM_82");

            } else if (ddlSecciones.SelectedValue == "3")
            {
                GetCategorias(3, IdCliente, "ITM_83");
            ...
            {
                GetCategorias(5, IdCliente, "ITM_85");
                ...
                foreach (GridViewRow row in GrdDocCarpeta.Rows)
                {
                    if (row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (chkbox.Checked)
                        {
                            ...
                            string strQuery = "INSERT INTO ITM_88 (IdCliente, IdProyecto, IdTpoAsunto, IdSeccion, IdCategoria, IdDocumento, NomArchivo, IdUsuario, IdStatus) " +
        ...
        protected void Eliminar_ITM_88()
        {
            try
            {
                ...
                // Eliminar registro(s) tablas (ITM_88)
                string strQuery = "DELETE FROM ITM_88 " +
