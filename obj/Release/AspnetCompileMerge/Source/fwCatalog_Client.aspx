        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    ...
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomCliente" runat="server" CssClass="form-control form-control-sm" placeholder="Nombre del Cliente" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="d-grid gap-4 d-flex justify-content-center mt-2 mb-3">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Button ID="BtnProyecto" runat="server" Text="Alta Proyectos" OnClick="BtnProyecto_Click" CausesValidation="true" CssClass="btn btn-primary px-4" TabIndex="3"/>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdCliente"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripción del cliente" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
