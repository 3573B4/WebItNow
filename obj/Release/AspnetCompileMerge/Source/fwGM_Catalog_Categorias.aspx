<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Catalog_Categorias.aspx.cs" Inherits="WebItNow_Peacock.fwGM_Catalog_Categorias" %>
...
--%>
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4">
                    <div class ="mb-2">
                        <asp:Label ID="LblSecciones" runat="server" Text="Categorias Por" ></asp:Label>
                    </div>
                    <div class=" input-group input-group-sm">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblCategoria" runat="server" Text="Descripción de Categoría" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomCategoria" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="Descripción de Categoría" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
