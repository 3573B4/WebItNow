<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Mnu_Dinamico.aspx.cs" Inherits="WebItNow_Peacock.GastosMedicos.fwGM_Mnu_Dinamico" %>
    ...
    <div class="container col-lg-7 col-md-8 col-sm-8">
        <div class="row mb-2 py-4">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="input-group input-group-sm">
                    ...
                    <h2 class="h2 mb-3 fw-normal mt-4 align-content-center">GASTOS MEDICOS MAYORES</h2>
                </div>
            </div>
        </div>
        <br />
        <div class="d-flex flex-row">
            <div class="mx-2" style="width: 10rem; height: 10rem;">
                <a href="fwGM_Alta_Asunto.aspx">
                    <img src="<%= ResolveUrl("~/Images/alta_referencia.png") %>" class="img-fluid" alt="..." />
                </a>
            </div>

            <div class="mx-2" style="width: 10rem; height: 10rem;">
                <a href="fwGM_Reporte_Alta_Asunto.aspx">
                    <img src="<%= ResolveUrl("~/Images/consultas.png") %>" class="img-fluid" alt="..." />
                </a>
            </div>

            <div class="mx-2" style="width: 10rem; height: 10rem;">
                <a id="lnkAlta_Proyecto" runat="server" href="fwGM_Alta_Proyecto.aspx">
