<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Catalog_Hospitales.aspx.cs" Inherits="WebItNow_Peacock.fwGM_Catalog_Hospitales" %>
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Zona - Hospital</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <asp:Panel ID="MainPanel" runat="server" Visible="true">
                ...
                <div class="row mb-3">
                        ...
                        <div class="col-lg-4 col-md-4">
                            ...
                            <div class=" input-group input-group-sm">
                                <asp:Button ID="btnMostrarPanel" runat="server" Text="Agregar Zona" OnClick="btnMostrarPanel_Click" CausesValidation="true" CssClass="btn btn-primary px-4" TabIndex="3"/>
                            </div>
                        </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-4 col-md-4 ">
                        <div class ="mb-2">
                            <asp:Label ID="LblNomHospital" runat="server" Text="Nombre Hospital"></asp:Label>
                        </div>
                        <div class="input-group input-group-sm">
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Hospitales</h6>
                </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdTasks"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            DataKeyNames="IdHospital" PageSize="10" Font-Size="Smaller" HeaderStyle-HorizontalAlign="Left" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="NomHospital" HeaderText="Descripción Hospital" >
                                </asp:BoundField>
                                <asp:BoundField DataField="IdHospital" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
            ...
            <asp:Panel ID="PanelAgregarProtocolo" runat="server" Visible="false">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <h6 class="h6 fw-normal my-1" style="font-size:small">Agregar Zona</h6>
                </div>

                <div class="row mb-3">
                    <div class="col-lg-4 col-md-4 ">
                        <div class ="mb-2">
                            <asp:Label ID="LblNomZona" runat="server" Text="Nombre de la Zona"></asp:Label>
                        </div>
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="TxtSLA_Protocolo" runat="server" CssClass="form-control form-control-sm" placeholder="Nombre de la Zona" AutoComplete="off" MaxLength="60"></asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Zonas</h6>
                </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdProtocolos"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            DataKeyNames="IdZona" PageSize="10" Font-Size="Smaller" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="IdZona" >
                                </asp:BoundField>
                                <asp:BoundField DataField="NomZona" HeaderText="Nombre Zona" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
