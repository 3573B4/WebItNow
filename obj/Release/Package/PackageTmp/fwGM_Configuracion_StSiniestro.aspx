<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Configuracion_StSiniestro.aspx.cs" Inherits="WebItNow_Peacock.fwGM_Configuracion_StSiniestro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <ContentTemplate>
                ...
                <div class="row mb-2 py-4">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="input-group input-group-sm">
                            <h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Configuración de Estatus por Etapas</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-lg-7 col-md-8 col-sm-8">
                ...
                <div class="row mb-3">
                    <div class="col-lg-4 col-md-4">
                        <div class ="mb-2">
                            <asp:Label ID="LblEstSiniestro" runat="server" Text="Estatus del siniestro" ></asp:Label>
                        </div>
                        <div class=" input-group input-group-sm">
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9; align-items: baseline;">
                    <div class="col-10" style="padding-left: 14px;">
                        <asp:Label ID="LblDocumentos" runat="server" Text="Etapas del Estatus" CssClass="control-label" Font-Size="small"></asp:Label>
                    </div>
                    <div class="col-2" style="display:flex; justify-content: end;">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Button ID="BtnEtapas" runat="server" Text="+" OnClick="BtnEtapas_Click" Height="24px" Width="24px" CssClass="btn btn-primary btn-sm justify-content-center align-items-center p-0 m-0" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdTareas"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdTareas_PageIndexChanging" OnRowCommand="GrdTareas_RowCommand" OnPreRender="GrdTareas_PreRender"
                            OnSelectedIndexChanged="GrdTareas_SelectedIndexChanged" OnRowDataBound="GrdTareas_RowDataBound" 
                            DataKeyNames="IdEtapa_Estatus" PageSize="10" Font-Size="Smaller" HeaderStyle-HorizontalAlign="Left" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripción de la Etapa" >
                                </asp:BoundField>
                                <asp:BoundField DataField="IdEtapa_Estatus" >
                                </asp:BoundField>
                                <asp:BoundField DataField="IdProyecto" >
                                </asp:BoundField>
                                <asp:BoundField DataField="IdEstatus" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">  
                                        <ContentTemplate>
                                        <asp:GridView ID="GrdEtapas" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%"
                                            AllowPaging="False" CssClass="table table-responsive table-light table-striped table-hover align-middle"
                                            AlternatingRowStyle-CssClass="alt" OnRowDataBound="GrdEtapas_RowDataBound"
    ...
    <Triggers>
        <asp:PostBackTrigger ControlID="BtnEtapas" />
