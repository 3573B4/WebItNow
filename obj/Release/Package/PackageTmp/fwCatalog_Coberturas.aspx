<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Coberturas.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Coberturas" %>
...
--%>
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    ...
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomCobertura" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="Descripción de Cobertura" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
