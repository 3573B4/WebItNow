            ...
            <div class="container col-lg-7 col-md-8 col-sm-8 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="TxtNumPoliza" runat="server" CssClass="form-control form-control-sm" MaxLength="18"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <asp:Panel ID="pnl4" runat="server" Visible="false">
                    ...
                    <asp:Panel ID="pnl17" runat="server" Visible="false">
                        <div class="row mb-3">
                            <div class="col-lg-4 col-md-4">
                                <div class ="mb-2">
                                    <asp:Label ID="LblCoberturas" runat="server" Text="Coberturas Por" ></asp:Label>
                                </div>
                                <div class=" input-group input-group-sm">
...
--%>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnShowPanel0" />
            <asp:PostBackTrigger ControlID="btnShowPanel1" />
            <asp:PostBackTrigger ControlID="btnShowPanel3" />
            <asp:PostBackTrigger ControlID="btnShowPanel4" />
            <asp:PostBackTrigger ControlID="btnShowPanel5" />
            <asp:PostBackTrigger ControlID="btnShowPanel6" />
            <asp:PostBackTrigger ControlID="btnShowPanel7" />
            <asp:PostBackTrigger ControlID="btnShowPanel8" />
            <asp:PostBackTrigger ControlID="btnShowPanel9" />
            <asp:PostBackTrigger ControlID="btnShowPanel10" />
            <asp:PostBackTrigger ControlID="btnShowPanel11" />
            <asp:PostBackTrigger ControlID="btnShowPanel12" />
            <asp:PostBackTrigger ControlID="btnShowPanel13" />
            <asp:PostBackTrigger ControlID="btnShowPanel14" />
            <asp:PostBackTrigger ControlID="btnShowPanel15" />
            <asp:PostBackTrigger ControlID="btnShowPanel16" />
            <asp:PostBackTrigger ControlID="btnShowPanel17" />
