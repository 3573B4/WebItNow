        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-6 col-md-6 ">
                    <div class="mb-2">
                        <asp:Label ID="LblDescProducto" runat="server" Text="Descripción de Producto" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomProducto" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="Descripción de Producto" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblNumCondusef" runat="server" Text="Num. Registro CONDUSEF" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNumCondusef" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="Número de Registro CONDUSEF" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdProductos"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Num_Condusef" HeaderText="Registro CONDUSEF" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
