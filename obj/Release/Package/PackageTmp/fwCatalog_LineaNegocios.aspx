    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class ="mb-2">
                        <asp:Label ID="LblLineaNegocio" runat="server" Text="Nombre Linea de Negocio"></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtLineaNegocio" runat="server" CssClass="form-control form-control-sm" placeholder="Nombre Linea de Negocio" AutoComplete="off" MaxLength="60"></asp:TextBox>
                    </div>
                </div>
            </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdLineaNegocios"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NomLineaNegocio" HeaderText="Descripción" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
