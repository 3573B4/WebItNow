...
--%>
                            ...
                            <asp:BoundField DataField="Tpo_Asunto" HeaderText="Tipo de Asunto" >
                            ...
                            <asp:BoundField DataField="Resp_Tecnico" HeaderText="Responsable Técnico" >
                            <%--<ItemStyle Width="600px" />--%>
                            </asp:BoundField>
                            <asp:BoundField DataField="Resp_Administrativo" HeaderText="Responsable Administrativo" >
                            <%--<ItemStyle Width="600px" />--%>
                            </asp:BoundField>
                            <asp:BoundField DataField="Referencia_Anterior" HeaderText="Referencia Anterior" >
                            <%--<ItemStyle Width="300px" />--%> 
                            </asp:BoundField>
...
<%--        <asp:Panel ID="pnlMensaje_1" runat="server" CssClass="CajaDialogo" style="display: none; border: none; border-radius: 10px; width: 400px; background-color:#FFFFFF;">
            ...
            <!-- DropDownList que se mostrará solo si se cumple la condición -->
            <div class="input-group input-group-sm">
                <asp:DropDownList ID="ddlProcedimiento" runat="server" CssClass="btn btn-outline-secondary text-start" OnSelectedIndexChanged="ddlTpoJuicio_SelectedIndexChanged" Visible="false" >
                </asp:DropDownList>
            </div>        
