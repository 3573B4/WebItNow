<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_LineaNegocios.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_LineaNegocios" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Linea de Negocio</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Linea_Neg" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class ="mb-2">
                        <asp:Label ID="LblLineaNegocio" runat="server" Text="<%$ Resources:GlobalResources, lblLineaNegocio %>"></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtLineaNegocio" runat="server" CssClass="form-control form-control-sm" placeholder="<%$ Resources:GlobalResources, lblLineaNegocio %>" AutoComplete="off" MaxLength="60"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <%--<h6 class="h6 fw-normal my-1" style="font-size:small">Consulta Linea de Negocios</h6>--%>
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, hdrLineaNegocios %>" />
                    </h6>
                </div>

                <%-- Catalogo de LineaNegocios --%>
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdLineaNegocios"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdLineaNegocios_PageIndexChanging" OnRowCommand="GrdLineaNegocios_RowCommand" OnPreRender="GrdLineaNegocios_PreRender"
                            OnSelectedIndexChanged="GrdLineaNegocios_SelectedIndexChanged" OnRowDataBound="GrdLineaNegocios_RowDataBound" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Cve_LineaNeg" HeaderText="<%$ Resources:GlobalResources, col_Cve_LineaNeg %>" >
                                </asp:BoundField>
                                <asp:BoundField DataField="NomLineaNegocio" HeaderText="<%$ Resources:GlobalResources, col_NomLineaNegocio %>" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
