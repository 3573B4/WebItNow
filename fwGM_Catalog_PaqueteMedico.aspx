<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Catalog_PaqueteMedico.aspx.cs" Inherits="WebItNow_Peacock.fwGM_Catalog_PaqueteMedico" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Paquete Médico</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-3 col-md-3">
                    <div class="mb-2">
                        <asp:Label ID="LblMontoMinimo" runat="server" Text="Monto Minimo" CssClass="form-label"></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="mb-2">
                        <asp:Label ID="LblMontoMaximo" runat="server" Text="Monto Maximo" CssClass="form-label"></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Paquetes Médicos</h6>
                </div>

                <%-- Catalogo de paquetes medicos --%>
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdPaquetes" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdPaquetes_PageIndexChanging" OnRowCommand="GrdPaquetes_RowCommand" OnPreRender="GrdPaquetes_PreRender"
                            OnSelectedIndexChanged="GrdPaquetes_SelectedIndexChanged" OnRowDataBound="GrdPaquetes_RowDataBound" 
                            DataKeyNames="Id_Paquete" PageSize="10" Font-Size="Smaller" HeaderStyle-HorizontalAlign="Left" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="Id_Paquete" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Id_Institucion" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Nom_Paquete" HeaderText="Nombre del Paquete" >
                                </asp:BoundField>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="GrdPaquetes" />
