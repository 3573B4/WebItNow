...
{
    public partial class fwGM_Alta_Proyecto : System.Web.UI.Page
    {
        ...
        protected void GetTipoEvento()
        {
            try
            {
                ...
                ddlTpoAsunto.DataValueField = "IdTpoEvento";
        ...
        protected void GetGerentes()
        {
            try
            {
                ...
                ddlGerentes.DataValueField = "IdRespMedico";
        ...
        public void GetProyectos(string sCliente)
        {
            try
            {
                ...
                if (sCliente == "0")
                {
                    strQuery = "SELECT a.IdProyecto, a.Descripcion, b.Descripcion As NomCliente, a.IdCliente, c.Descripcion As DescAsunto, c.IdTpoEvento, NumPoliza " +
                               "  FROM ITM_26 as a, ITM_67 as b, ITM_11 as c " +
                               " WHERE a.IdCliente = b.IdSeguros " +
                               "   AND a.IdTpoAsunto = c.IdTpoEvento " +
                               "   AND a.IdStatus <> 9";
                }
                else
                {
        ...
        protected void Eliminar_ITM_26()
        {
            try
            {
                ...
                // Eliminar registro(s) tablas (ITM_26)
                // string strQuery = "DELETE ITM_26 " +
                //                   " WHERE IdProyecto = " + iConsecutivo + "";

                string strQuery = "UPDATE ITM_26 " +
                                  "   SET IdStatus = 9 " +
                                  " WHERE IdProyecto = " + iConsecutivo + " ";
        ...
        protected void GrdProyectos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "SelectProyecto")
            {
                ...
                Response.Redirect("fwGM_Configuracion_Proyect.aspx?Proyecto=" + iProyecto, true);
            }
        }
        ...
        protected void BtnSiguiente_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("fwGM_Configuracion_Proyect.aspx", true);
            return;
