<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Catalog_Responsable.aspx.cs" Inherits="WebItNow_Peacock.fwGM_Catalog_Responsable" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4">
                    <div class ="mb-2">
                        <asp:Label ID="LblResponsables" runat="server" Text="Responsable" ></asp:Label>
                    </div>
                    <div class=" input-group input-group-sm">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblResponsable" runat="server" Text="Nombre de Responsable" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomResponsable" runat="server" CssClass="form-control form-control-sm" placeholder="Nombre de Responsable" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
