...
{
    public partial class fwConfiguracion_StSiniestro : System.Web.UI.Page
    {
                ...
                foreach (GridViewRow row in GrdEtapas.Rows)
                {
                    if (row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (chkbox.Checked)
                        {
                            ...
                            //string strQuery = "INSERT INTO ITM_53 (IdCliente, IdProyecto, IdTpoAsunto, IdEstatus, IdEtapa, NomEtapa, IdUsuario, IdStatus) " +
                            //                  "VALUES ('" + IdCliente + "', " + IdProyecto + ", " + IdTpoAsunto + ", " + IdEstatus + ", " + IdEtapa + ", '" + NomEtapa + "', '" + IdUsuario + "', 1)" + "\n \n";

                            string strQuery = @"INSERT INTO ITM_53 (IdCliente, IdProyecto, IdTpoAsunto, IdEstatus, IdEtapa, NomEtapa, IdUsuario, IdStatus) " +
                                               "SELECT '" + IdCliente + "', " + IdProyecto + ", " + IdTpoAsunto + ", " + IdEstatus + ", " + IdEtapa + ", '" + NomEtapa + "', '" + IdUsuario + "', 1 " +
                                               " WHERE NOT EXISTS ( " +
                                               "SELECT 1 FROM ITM_53 " +
                                               " WHERE IdCliente = '" + IdCliente + "' " +
                                               "   AND IdProyecto = " + IdProyecto + " " +
        ...
        protected void Eliminar_ITM_53()
        {
            try
            {
                ...
                string strQuery = "DELETE FROM ITM_53 " +
