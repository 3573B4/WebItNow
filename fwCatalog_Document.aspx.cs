...
{
    public partial class fwCatalog_Document : System.Web.UI.Page
    {
        ...
        public void GetCatalog_TpoDocumento()
        {
            try
            {
        ...
        protected void BtnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Insertar registro tabla (ITM_12)
                string strQuery = "INSERT INTO ITM_90 (IdConsecutivo, IdCarpeta, Descripcion, DescripBrev, DocInterno, IdStatus) " +
        ...
        protected void Eliminar_ITM_90()
        {
            try
            {
                ...
                // Eliminar registro(s) tablas (ITM_90)
                string strQuery = "DELETE FROM ITM_90 " +
        ...
        protected void Actualizar_ITM_90()
        {
            try
            {
                ...
                // Actualizar registro(s) tablas (ITM_90)
                string strQuery = "UPDATE ITM_90 " +
