<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Productos.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Productos" %>
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Productos</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Productos" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-6 col-md-6 ">
                    <div class="mb-2">
                        <asp:Label ID="LblDescProducto" runat="server" Text="<%$ Resources:GlobalResources, lblDescProducto %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomProducto" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="<%$ Resources:GlobalResources, lblDescProducto %>" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblNumCondusef" runat="server" Text="<%$ Resources:GlobalResources, lblNumCondusef %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNumCondusef" runat="server" CssClass="form-control form-control-sm" onkeyup="mayus(this);" placeholder="<%$ Resources:GlobalResources, lblNumCondusef %>" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <%--<h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Productos</h6>--%>
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, hdrConsultaProductos %>" />
                    </h6>
                </div>

                <%-- Catalogo de clientes --%>
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdProductos"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdProductos_PageIndexChanging" OnRowCommand="GrdProductos_RowCommand" OnPreRender="GrdProductos_PreRender"
                            OnSelectedIndexChanged="GrdProductos_SelectedIndexChanged" OnRowDataBound="GrdProductos_RowDataBound" 
                            DataKeyNames="IdProducto" PageSize="10" Font-Size="Smaller" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="IdProducto" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Cve_Producto" HeaderText="<%$ Resources:GlobalResources, col_Cve_Producto %>" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Descripcion" HeaderText="<%$ Resources:GlobalResources, col_Desc_Producto %>" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Num_Condusef" HeaderText="<%$ Resources:GlobalResources, col_Num_Condusef %>" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
