<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Alta_Asunto.aspx.cs" Inherits="WebItNow_Peacock.GastosMedicos.fwGM_Alta_Asunto" %>
            ...
            <div class="form-floating mt-3 py-5">
                ...
                <div class="form-floating mt-3">
                    <asp:Label ID="LblTipoEvento" runat="server" Text="Tipo de Evento" ></asp:Label>
                        <asp:CustomValidator ID="cvTipoEvento" runat="server" ControlToValidate="ddlTipoEvento" 
                        OnServerValidate ="cvTipoEvento_ServerValidate" ErrorMessage="*" ForeColor="Red" Display="Dynamic" >
                        </asp:CustomValidator>
                ...
                <div class="form-group mt-4">
                    <asp:Label ID="LblHoraAsignacion" runat="server" Text="Hora de Asignación" CssClass="control-label" Font-Size="Small"></asp:Label>
                        <asp:RequiredFieldValidator ID="rfvHoraAsignacion" runat="server"
                        ControlToValidate="TxtHoraAsignacion" ErrorMessage="*" ForeColor="Red">
                        </asp:RequiredFieldValidator>
                    <div class="col-sm-12">
                        <asp:TextBox ID="TxtHoraAsignacion" runat="server" CssClass="form-control form-control-sm" 
                                onkeydown="if(event.key === 'Enter'){event.preventDefault(); return false;}"
                                oninput="this.value = this.value.replace(/[^0-9:]/g, '');" MaxLength ="5" TabIndex="6"></asp:TextBox>
                    </div>
                </div>

                <div class="form-floating mt-3">
                    <asp:Label ID="LblRespMedico" runat="server" Text="Responsable Médico Dictaminador" ></asp:Label>
                        <asp:CustomValidator ID="cvRespMedico" runat="server" ControlToValidate="ddlRespMedico" 
                        OnServerValidate ="cvRespMedico_ServerValidate" ErrorMessage="*" ForeColor="Red" Display="Dynamic" >
                        </asp:CustomValidator>
                    <asp:DropDownList ID="ddlRespMedico" runat="server" CssClass="btn btn-outline-secondary text-start" Width="100%" TabIndex="14">
                    </asp:DropDownList>
                </div>
