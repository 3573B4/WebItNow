<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwGM_Catalog_Document.aspx.cs" Inherits="WebItNow_Peacock.fwGM_Catalog_Document" %>
...
--%>
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4">
                    <div class ="mb-2">
                        <asp:Label ID="LblCarpetas" runat="server" Text="Tipo de carpeta" ></asp:Label>
                    </div>
                    <div class=" input-group input-group-sm">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblDescripBrev" runat="server" Text="Descripción del documento (Corta)" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtDescripBrev" runat="server" CssClass="form-control form-control-sm" placeholder="Descripción (Corta)" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                    ...
                    <div class="input-group input-group-sm checkbox-container">
                        <asp:CheckBox ID="chkDocInterno" runat="server" /> <span> &nbsp;&nbsp; Documento Interno</span>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-lg-8 col-md-8 ">
                    <div class="mb-2">
                        <asp:Label ID="LblDescripcion" runat="server" Text="Descripción del documento (Larga)" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
            ...
            <div style="overflow-x: auto; overflow-y:hidden">
                <asp:GridView ID="GrdDocumentos"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TpoInterno" HeaderText="Tpo. Documento">
