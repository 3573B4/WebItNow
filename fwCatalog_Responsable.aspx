<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Responsable.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Responsable" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Responsables</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Responsables" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4">
                    <div class ="mb-2">
                        <asp:Label ID="LblResponsable" runat="server" Text="<%$ Resources:GlobalResources, lblResponsable %>" ></asp:Label>
                    </div>
                    <div class=" input-group input-group-sm">
                        <asp:DropDownList ID="ddlResponsables" runat="server" CssClass="btn btn-outline-secondary text-start" AutoPostBack="true" OnSelectedIndexChanged="ddlResponsables_SelectedIndexChanged" Width="100%">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblNomResponsable" runat="server" Text="<%$ Resources:GlobalResources, lblNomResponsable %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomResponsable" runat="server" CssClass="form-control form-control-sm" placeholder="<%$ Resources:GlobalResources, lblNomResponsable %>" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    ...
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, hdrConsultaResponsable %>" />
                    </h6>
                </div>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdResponsables"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Descripcion" HeaderText="<%$ Resources:GlobalResources, col_Categoria %>" >
                                </asp:BoundField>
