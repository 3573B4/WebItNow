<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Document.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Document" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style type="text/css">
        .checkbox-text-space input[type="checkbox"] {
            margin-right: 6px; /* separación visual */
        }
    </style>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Documentos</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Documentos" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4">
                    <div class ="mb-2">
                        <asp:Label ID="LblCarpetas" runat="server" Text="<%$ Resources:GlobalResources, lblCarpetas %>" ></asp:Label>
                    </div>
                    <div class=" input-group input-group-sm">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblDescripBrev" runat="server" Text="<%$ Resources:GlobalResources, lblDescripBrev %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtDescripBrev" runat="server" CssClass="form-control form-control-sm" placeholder="<%$ Resources:GlobalResources, lblDescripBrev %>" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                    ...
                    <%--<div class="input-group input-group-sm" style="display: flex; align-items: center;">--%>
                        <%--<asp:CheckBox ID="chkDocInterno" runat="server" Text="Documento Interno &nbsp;&nbsp;" TextAlign="Left" style="display: inline-flex; align-items: center;"/>--%>
                    <%--</div>--%>
                    <div class="input-group input-group-sm checkbox-container">
                        <%--<asp:CheckBox ID="chkDocInterno" runat="server" /> <span><%$ Resources:GlobalResources, lblDocInterno %></span>--%>
                        <div class="input-group input-group-sm checkbox-container mb-2">
                            <asp:CheckBox ID="chkDocInterno" runat="server" CssClass="checkbox-text-space" Text="<%$ Resources:GlobalResources, lblDocInterno %>" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-lg-8 col-md-8 ">
                    <div class="mb-2">
                        <asp:Label ID="LblDescripcion" runat="server" Text="<%$ Resources:GlobalResources, lblDescripLarga %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
        ...
        <div class="container col-12 mt-4">
            <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                <%--<h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Documentos</h6>--%>
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, hdrConsultaDocumentos %>" />
                    </h6>
            </div>
            ...
            <div style="overflow-x: auto; overflow-y:hidden">
                <asp:GridView ID="GrdDocumentos"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TpoInterno" HeaderText="<%$ Resources:GlobalResources, col_TpoDocumento %>">
