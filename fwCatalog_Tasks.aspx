<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Tasks.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Tasks" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Tareas</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Tareas" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-8 col-md-8 ">
                    <div class="mb-2">
                        <asp:Label ID="LblTarea" runat="server" Text="<%$ Resources:GlobalResources, lblDescTarea %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtTarea" runat="server" CssClass="form-control form-control-sm" AutoComplete="off" MaxLength="2500" Columns="8" Rows="3" TextMode="MultiLine" ></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    ...
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtPlazo" runat="server" CssClass="form-control form-control-sm" placeholder="<%$ Resources:GlobalResources, lblPlazo %>" AutoComplete="off" MaxLength="60"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                    ...
                    <div class="input-group input-group-sm checkbox-container mb-2">
                        <asp:CheckBox ID="chkTaskInterno" runat="server" CssClass="checkbox-text-space" Text="<%$ Resources:GlobalResources, lblTareaInterna %>" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                <%--<h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Tareas</h6>--%>
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, hdrConsultaTareas %>" />
                    </h6>
            </div>
