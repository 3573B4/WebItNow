<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_StSiniestro.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_StSiniestro" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo Estatus del Siniestro</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Estatus" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblEstatus" runat="server" Text="Nombre del Estatus" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomEstatus" runat="server" CssClass="form-control form-control-sm" placeholder="Nombre del Estatus" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <h6 class="h6 fw-normal my-1" style="font-size:small">Consulta Estatus del Siniestro</h6>
                </div>

                <%-- Catalogo de clientes --%>
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdStSiniestro"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdStSiniestro_PageIndexChanging" OnRowCommand="GrdStSiniestro_RowCommand" OnPreRender="GrdStSiniestro_PreRender"
                            OnSelectedIndexChanged="GrdStSiniestro_SelectedIndexChanged" OnRowDataBound="GrdStSiniestro_RowDataBound" 
                            DataKeyNames="IdEstStatus" PageSize="10" Font-Size="Smaller" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="IdEstStatus" HeaderText="Id" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Cve_EstStatus" HeaderText="Cve. Estatus" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripción del estatus" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
