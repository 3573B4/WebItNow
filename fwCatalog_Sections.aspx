<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="fwCatalog_Sections.aspx.cs" Inherits="WebItNow_Peacock.fwCatalog_Sections" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="row mb-2 py-4">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group input-group-sm">
                        <%--<h2 class="h2 mb-3 fw-normal mt-4 align-content-center">Catálogo de Secciones</h2>--%>
                        <asp:Label ID="lblTitulo_Cat_Secciones" runat="server" CssClass="h2 mb-3 fw-normal mt-4 align-content-center" style="display:block; text-align:center;" ></asp:Label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container col-md-8 col-lg-10 mt-4">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-md-4 ">
                    <div class="mb-2">
                        <asp:Label ID="LblNomSeccion" runat="server" Text="<%$ Resources:GlobalResources, lblNomSeccion %>" ></asp:Label>
                    </div>
                    <div class="input-group input-group-sm">
                        <asp:TextBox ID="TxtNomSeccion" runat="server" CssClass="form-control form-control-sm" placeholder="<%$ Resources:GlobalResources, lblNomSeccion %>" AutoComplete="off" MaxLength="50"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="container col-12 mt-4">
                <div class="row mb-3 mt-4" style="background-color:#96E7D9;">
                    <%--<h6 class="h6 fw-normal my-1" style="font-size:small">Consulta de Secciones</h6>--%>
                    <h6 class="h6 fw-normal my-1" style="font-size:small">
                        <asp:Literal runat="server" Text="<%$ Resources:GlobalResources, lblTitulo_Consulta_Secciones %>" />
                    </h6>
                ...
                <div style="overflow-x: auto; overflow-y:hidden">
                    <asp:GridView ID="GrdSeccion"  runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" 
                            ...
                            OnPageIndexChanging="GrdSeccion_PageIndexChanging" OnRowCommand="GrdSeccion_RowCommand" OnPreRender="GrdSeccion_PreRender"
                            OnSelectedIndexChanged="GrdSeccion_SelectedIndexChanged" OnRowDataBound="GrdSeccion_RowDataBound" 
                            DataKeyNames="IdSeccion" PageSize="10" Font-Size="Smaller" >
                            <AlternatingRowStyle CssClass="alt autoWidth" />
                            <Columns>
                                <asp:BoundField DataField="IdSeccion" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Cve_Seccion" HeaderText="<%$ Resources:GlobalResources, col_Cve_Seccion %>" >
                                </asp:BoundField>
                                <asp:BoundField DataField="Descripcion" HeaderText="<%$ Resources:GlobalResources, col_Desc_Seccion %>" >
                                </asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
